...
<header class="border-b sticky top-0 z-10 bg-white shadow  box-border relative">
    ...
    <div id="mobile-menu-dropdown" class="lg:hidden absolute w-full mx-auto"
         style="display: none;">
        ...
        <div class="min-h-screen bg-gray-50/10 backdrop-filter backdrop-blur-sm">
