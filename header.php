...
<!--                --><?php
//                // Get menu instance
//                $menu_class = \iscece\Inc\Menus::get_instance();
//                $menu_class
//                wp_nav_menu(
//                    array(
//                        'container_id' => 'primary-menu',
//                        'container_class' => 'top-0 left-0 absolute lg:static hidden bg-gray-200 mt-4 p-4 lg:mt-0 lg:p-0 lg:bg-transparent lg:block',
