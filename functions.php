...
function tailpress_enqueue_scripts()
{
    ...
    wp_enqueue_script('tailpress', tailpress_get_mix_compiled_asset_url('js/app.js'), array(), $theme->get('Version'), true);
}
...
//        Routes::load('custom_pages/papers.php', null, null, 200);
    ...
    Routes::map('conference', function ($params) {
//        $query = 'posts_per_page=3&post_type=' . $params['name'];
//        Routes::load('custom_pages/conference.php', null, $query, 200);
        Routes::load('custom_pages/conference.php', null, null, 200);
    });
}
